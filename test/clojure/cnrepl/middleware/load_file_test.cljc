...
(def-repl-test load-file-with-debug-info
  (dorun
   (nrepl/message timeout-session
                  {:op "load-file"
                   :file (slurp
                          #?(:clj (File. project-base-dir "load-file-test/nrepl/load_file_sample.clj")
                             :cljr (Path/Combine (str project-base-dir) "load-file-test/clojure/tools/nrepl/load_file_sample.clj")))
